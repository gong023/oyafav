...
require_once 'Oyafav_Error.php';
require_once 'Oyafav_ActionClass.php';
require_once 'Oyafav_ActionForm.php';
require_once 'Oyafav_ViewClass.php';

/**
 *  Oyafav application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Oyafav
 */
class Oyafav_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $class = array(
        ...
        'form'          => 'Oyafav_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Oyafav_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Oyafav_UrlHandler',
    );
